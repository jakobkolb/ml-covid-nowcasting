...
def plot_analysis(classifier, X_test, y_test, feature_names, threshold):
    ...
    with plt.style.context('seaborn'):
        ...
        plot_feature_importance(axes['left'], classifier, x_resampled, y_resampled, feature_names)
        plot_confusion_matrix_with_threshold(axes['lower right'], classifier, x_resampled, y_resampled, threshold)
